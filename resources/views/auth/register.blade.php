...
<head>
    ...
    <title>Créer un compte - OWEW</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div class="auth-branding">
                <div class="auth-logo">
                    <img src="{{ asset('img/logos/logo.png') }}" alt="OWEW Logo" height="30">
                </div>
                <div class="auth-branding-content">
                    <h1 class="auth-branding-title">Rejoignez OWEW</h1>
                    <p class="auth-branding-text">
                        Créez votre compte et faites partie d'une communauté qui change des vies.
                    </p>
                </div>
            ...
            <div class="auth-form-container">
                <div class="auth-form-header">
                    ...
                    <p class="auth-form-subtitle">Remplissez le formulaire pour commencer</p>
                </div>
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                                required>
                            <button type="button" class="password-toggle" onclick="togglePass('password_confirmation')">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="terms">
                            J'accepte les <a href="{{ route('legal') }}" class="auth-link">conditions d'utilisation</a>
                            et la <a href="{{ route('privacy') }}" class="auth-link">politique de confidentialité</a>
                        </label>
                    </div>
